...
def run_episode(
    ...
    metrics = {
        ...
        # Paper-style D_j surrogate: the smallest observed safety margin.
        # It is monotonic with b_j near the boundary and is minimized by FGO.
        "D_min": float(min(min_obs_clear, min_bar_clear)),
